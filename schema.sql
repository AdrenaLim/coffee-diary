-- Coffee Diary schema v1
CREATE TABLE IF NOT EXISTS brews (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
  method TEXT NOT NULL,              -- 'latte' | 'coldbrew'
  ...
  water_g REAL NOT NULL,            -- water used (brew + milk for latte)
  seconds INTEGER NOT NULL,         -- extraction / steep time
